...
export const PersonalInfoForm = () => {
  ...
  const inputStyles =
    "w-full pl-12! py-6! bg-custom-2 border-transparent font-(family-name:--font-subhead) shadow-none transition-colors outline-none focus:outline-none focus-visible:outline-none focus:ring-1! focus-visible:ring-1 focus:ring-[#4F8F87] focus-visible:ring-[#4F8F87] focus:border-[#4F8F87] focus-visible:border-[#4F8F87] focus:ring-offset-0 focus-visible:ring-offset-0 autofill:transition-colors autofill:duration-[5000s] autofill:ease-in-out";

  return (
    <React.Fragment>
      <form className="py-2! pb-14!">
        <div className="max-w-3xl mx-auto grid grid-cols-1 md:grid-cols-2 mt-10! md:mt-20 gap-x-4 md:gap-x-8 gap-y-4 md:gap-y-2">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="relative">
              ...
              >
                <SelectTrigger
                  className={`w-full pl-12! py-6! font-(family-name:--font-subhead) bg-custom-2 border-transparent shadow-none focus:ring-0 focus:ring-offset-0 focus-visible:ring-offset-0 focus-visible:outline-none focus-visible:border-[#4F8F87] focus-visible:ring-1 focus-visible:ring-[#4F8F87] data-[state=open]:border-[#4F8F87] data-[state=open]:ring-1 data-[state=open]:ring-[#4F8F87]`}
                >
                  <SelectValue className="font-(family-name:--font-subhead)" placeholder="Select Gender" />
                </SelectTrigger>
                <SelectContent
                  position="popper"
                  side="bottom"
                ...
                >
                  <SelectGroup className="px-1! py-1! font-(family-name:--font-subhead)">
